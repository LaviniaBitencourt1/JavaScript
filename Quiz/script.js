...
const perguntas = [
    {
        ...
        opcoes: ["Luis Eulaio de Bueno Vidigal Filho", "Luis Eulaio", "Luis de Bueno", "Luis Eulaio de Vidigal"], correta:0
    },
    {
        pergunta: "Qual o nome do nosso curso?", 
        opcoes: ["Anális e Desenvolvimento de sistemas", "Sistemas de informação", "Desenvolvimento de sistemas", "Ciência da Computação"], correta:2
        
    },
    {
        pergunta: "Em que ano foi fundada a nossa escola?",
        opcoes: ["1999", "1942", "1985", "1970"], correta:1
    }
]
